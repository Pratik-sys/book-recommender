...
- A basic **Book recommender**
- Based on the python Framework [Flask](https://flask.palletsprojects.com/en/1.1.x/) and prominent Data Analyis library [Pandas](https://pandas.pydata.org/). The application has the ability to recommend the books as per the ratings of the numerous users.
...
- [x] Functional UI using bootstrap 
